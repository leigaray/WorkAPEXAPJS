    ...
    if (userTracker) {
        ...
        function handleRecording(sessionCount, startButton, stopButton, saveButton, audioPlayer, loggingElement) {
            ...
            audioPlayer.addEventListener('play', () => {
                playerCanvas.style.display = "block";  // Show player canvas
                volumeCanvas.style.display = "none";   // Hide live canvas
                ...
                riverStyleSpectrumVisualizer(playerAnalyser, playerCanvas);
            });
            */
